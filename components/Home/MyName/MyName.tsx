...
export default function MyName(props: { finishedLoading: boolean }) {
  ...
  return (
    ...
    >
      ...
      >
        I&apos;m Experienced, forward-thinking{" "}
        <span className="text-AAsecondary">software engineer</span> skilled in
        problem-solving and <br className="md:block hidden" />
        specializing in building (and occasionally designing) exceptional
        digital experiences. <br className="md:block hidden" />
        Currently I&apos;m creating and deploying{" "}
        <span className="text-AAsecondary">Web</span> and{" "}
