    ...
    >
      ...
      <div className="flex flex-col space-y-8 md:space-y-28">
        ...
        >
          ...
          >
            <div className="relative rounded w-full h-full col-start-6 col-span-7 ">
              <a href={"https://degentaxi.io"} target="_blank" rel="noreferrer">
                <div
            ...
            >
              ...
              <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
                <p className="text-gray-300 md:text-gray-400 text-left ">
                  Developed Frontend, Backend and smartContract project,
                  including the{" "}
              ...
              >
                ...
                <span className="pr-4 z-10">Node, Express</span>
              </ul>
              <div className="z-10 flex fle-row space-x-5 ">
                <GithubIcon link="https://github.com/miclegoden/Taxi-betting-game-frontend" />
                <a
          ...
          <div className=" md:absolute py-4  md:grid md:grid-cols-12 w-full h-full  content-center ">
            ...
            >
              <div className="flex flex-col space-y-1 md:items-end z-10">
                ...
                <Link href={"https://www.reddevils.site"}>
                  <span className=" md:text-gray-200 text-AAsecondary font-bold text-xl hover:cursor-pointer">
                    Red Devil NFT
                  </span>
                </Link>
              ...
              <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
                <p className="text-gray-300 md:text-gray-400 text-left md:text-right">
                  NFT mint contract{" "}
                  <span className="text-AAsecondary"> Frontend </span> by
                  Next,Tailwind, Material UI{" "}
                  <span className="text-AAsecondary"> Designed </span>
                  <span className="text-AAsecondary"> MySelf</span>.
                </p>
              </div>
              <ul
                className="flex flex-wrap w-full text-gray-300 md:text-gray-400
              ...
              <div className="z-10 flex fle-row space-x-5 ">
                <GithubIcon link="https://github.com/miclegoden/Red-devil-FE-next-tailwind-" />
                <a
                  href="https://www.reddevils.site"
                  target={"_blank"}
                  rel="noreferrer"
        ...
        >
          ...
          >
            <div className="relative rounded w-full h-full col-start-6 col-span-7 ">
              <Link href={"https://bonespoker.com/"}>
                <div
          ...
          <div className=" md:absolute py-4  md:grid md:grid-cols-12 w-full h-full  content-center ">
            ...
            >
              ...
              <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
                <p className="text-gray-300 md:text-gray-400 text-left ">
                  This project allows you to play poker on Solana Network.
                </p>
              </div>
              <ul
                className="flex flex-wrap w-full text-gray-300 md:text-gray-400
              ...
              >
                ...
                <span className="pr-4 z-10">Next</span>
                <span className="pr-4 z-10">Poker</span>
              </ul>
              <div className="z-10 flex fle-row space-x-5 ">
                <GithubIcon link="https://github.com/miclegoden/bonspocker-new-frontend" />
                <a
                  href="https://bonespoker.com"
                  target={"_blank"}
                  rel="noreferrer"
                >
          ...
          <div className=" md:absolute py-4  md:grid md:grid-cols-12 w-full h-full  content-center ">
            ...
            >
              ...
              <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
                <p className="text-gray-300 md:text-gray-400 text-left md:text-right">
                  It&apos; a Job Sites{" "}
                  <span className="text-AAsecondary">job post</span> & be hired{" "}
              ...
              <ul
               ...
               text-sm font-Text2 md:justify-end"
              >
                <span className="pr-4 z-10">Job post</span>
                <span className="pr-4 z-10">Freelancer</span>
              ...
              <div className="z-10 flex fle-row space-x-5 sm:pt-0 pt-2">
                <GithubIcon link="https://github.com/miclegoden/VantaSite-Next-Tailwind" />
                <a
                  href="https://tfl-site-frontend.vercel.app/"
                  target={"_blank"}
                  rel="noreferrer"
